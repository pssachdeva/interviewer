...
OUTPUT_PATH = PROJECT_ROOT / "artifacts/opacity_form.pdf"
OUTPUT_PNG_PATH = PROJECT_ROOT / "artifacts/opacity_form.png"
...
def main() -> None:
    """Build and save the opacity form plot faceted by interview type."""
    configure_plot_style()
    ...
    for panel_idx, (panel_title, mask) in enumerate(subset_masks(results).items()):
        ...
        form_fractions = build_form_fraction_table(
            subset,
            mechanisms,
            FORM_ORDER,
